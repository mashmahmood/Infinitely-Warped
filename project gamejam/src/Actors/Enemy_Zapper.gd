...
export var damage_once : float = 16.0
...
var is_sphere_inside : bool = false #or, player_in_range
...
func move(delta: float) -> void:
	...
	if current_state == States.Dead:
		...
		if is_sphere_inside and attack_cooloff > 2.0:
			just_attacked = true
...
func _on_SphereDetector_body_entered(body: Node) -> void:
	is_sphere_inside = true


func _on_SphereDetector_body_exited(body: Node) -> void:
	is_sphere_inside = false
